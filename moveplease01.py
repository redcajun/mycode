#!/usr/bin/env python3
"""A simple script to move two files into ceph_storage/ Atlas Research | rzfeeser@alta.com"""

# standard library imports
import shutil   # shell utilities will be used to move files
import os       # provides access to low level os oeprations (agnostic to flavor of OS)
...
def main():
    ...
    xname = input('What is the name for kerrigan.obj? ')    # collect string input from the user
